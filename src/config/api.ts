...
export const API_CONFIG = {
  ...
  WEBHOOK_URL: import.meta.env.DEV ? '/api/webhook' : import.meta.env.VITE_WEBHOOK_URL || 'https://hungdang1.app.n8n.cloud/webhook/imgheadline',
  
  // Production: Use environment variable or fallback to actual URL
  PRODUCTION_WEBHOOK_URL: import.meta.env.VITE_WEBHOOK_URL || 'https://hungdang1.app.n8n.cloud/webhook/imgheadline',
